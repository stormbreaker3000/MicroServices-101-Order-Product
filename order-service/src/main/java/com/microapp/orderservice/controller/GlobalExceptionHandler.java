...
/**
 * Global exception handler for the order-service REST layer.
 * <p>
 * Converts Bean Validation failures (e.g. blank productId, negative quantity)
 * into a friendly HTTP 400 response instead of the default Spring error page.
 */
